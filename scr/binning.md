...
|---|---|---|---|---|
| 保守 | 0.0536（bins 1-2） | 0.1429（bins 3-4） | ~80% | 低坏账率，强抗风险 |
| 平衡（推荐） | 0.0800（bins 1-3） | 0.2666（bins 4-5） | ~95% | 自动审批与审核量平衡 |
| 增长 | 0.2666（bins 1-5） | 0.4157（bin 6） | ~100% | 最大自动通过，不做硬拒绝 |
